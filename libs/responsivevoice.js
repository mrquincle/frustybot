...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
  ...
  a.voicecollection = [{name: "Google UK English Male"}, {name: "Agnes"}, {name: "Daniel Compact"}, {name: "Google UK English Female"}, {
    ...
    {name: "Chinese Hong Kong", lang: "zh_HK_#Hans"}, {
      ...
      lang: "en-US"
    }, {name: "Samantha", lang: "en-US"}, {name: "Tessa", lang: "en-ZA"}, {name: "Monica", lang: "es-ES"},
    {name: "Paulina", lang: "es-MX"}, {name: "Satu", lang: "fi-FI"}, {name: "Amelie", lang: "fr-CA"}, {
      name: "Thomas",
      lang: "fr-FR"
      ...
      name: "Kyoko",
      lang: "ja-JP"
    }, {name: "Yuna", lang: "ko-KR"}, {name: "Ellen", lang: "nl-BE"}, {name: "Xander", lang: "nl-NL"}, {
      name: "Nora",
      lang: "no-NO"
    }, {name: "Zosia", lang: "pl-PL"}, {name: "Luciana", lang: "pt-BR"}, {name: "Joana", lang: "pt-PT"}, {
      name: "Ioana",
      lang: "ro-RO"
    }, {name: "Milena", lang: "ru-RU"}, {name: "Laura", lang: "sk-SK"}, {name: "Alva", lang: "sv-SE"}, {
      name: "Kanya",
      lang: "th-TH"
  ...
  a.cache_ios_voices = [{name: "he-IL", voiceURI: "he-IL", lang: "he-IL"}, {
    ...
    voiceURI: "th-TH",
    lang: "th-TH"
  }, {name: "pt-BR", voiceURI: "pt-BR", lang: "pt-BR"}, {name: "sk-SK", voiceURI: "sk-SK", lang: "sk-SK"}, {
    name: "fr-CA", voiceURI: "fr-CA",
    lang: "fr-CA"
  ...
  a.cache_ios9_voices = [{
    name: "Maged", voiceURI: "com.apple.ttsbundle.Maged-compact",
    lang: "ar-SA", localService: !0, "default": !0
  }, {
    name: "Zuzana",
    ...
    name: "Karen", voiceURI: "com.apple.ttsbundle.Karen-compact",
    lang: "en-AU", localService: !0, "default": !0
  }, {
    name: "Daniel",
    ...
    if (a.iOS9 && !a.iOS9_initialized) a.log("Initializing ios9"), setTimeout(function () {
      ...
      if (b.length > a.CHARACTER_LIMIT) {
        for (var f = b; f.length > a.CHARACTER_LIMIT;) {
          ...
          -1 == g && -1 == f.search(" ") && (g = 99);
          if (-1 == g || g >= a.CHARACTER_LIMIT)for (var k = f.split(" "), g = 0; g < k.length && !(d.length + k[g].length + 1 > a.CHARACTER_LIMIT); g++)d += (0 != g ?
              " " : "") + k[g]; else d = f.substr(0, g + 1);
      ...
      for (g = 0; g < h.length; g++)if (a.fallbackMode) {
        ...
        e.voice : f.systemvoice, g < h.length - 1 && 1 < h.length ? (d.onend = a.onPartEnd, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.onPartEnd)) : (d.onend = a.speech_onend, d.hasOwnProperty("addEventListener") && d.addEventListener("end", a.speech_onend)), d.onerror = e.onerror || function (b) {
          a.log("RV: Unknow Error");
          a.log(b)
        }, d.onpause = e.onpause, d.onresume = e.onresume, d.onmark = e.onmark, d.onboundary = e.onboundary || a.onboundary, d.pitch = null != e.pitch ? e.pitch : d.pitch, d.rate = a.iOS ? (null != e.rate ? e.rate * e.rate : 1) * d.rate :
      (null != e.rate ? e.rate : 1) * d.rate, d.volume = null != e.volume ? e.volume : d.volume) : (a.log("No Params received for current Utterance"), d.voice = f.systemvoice, d.onend = a.speech_onend, d.onboundary = a.onboundary, d.onerror = function (b) {
        a.log("RV: Unknow Error");
        a.log(b)
  ...
  a.speech_onend = function () {
    ...
    !0 === a.cancelled ? a.cancelled = !1 : (a.log("on end fired"), null != a.msgparameters && null != a.msgparameters.onend && 1 != a.msgparameters.onendcalled && (a.log("Speech on end called  -" +
      a.msgtext), a.msgparameters.onendcalled = !0, a.msgparameters.onend()))
  };
  ...
  a.fallback_startPart = function () {
    ...
    if (null ==
      a.fallback_audio) a.log("RV: Fallback Audio is not available"); else {
  ...
  a.mapRVs = function () {
    for (var b = 0; b < a.responsivevoices.length; b++)for (var c =
      a.responsivevoices[b], e = 0; e < c.voiceIDs.length; e++) {
    ...
    var e = function () {
      return function (a, b) {
        ...
        if (Symbol.iterator in Object(a)) {
          ...
          try {
            for (var g = a[Symbol.iterator](), h; !(d = (h = g.next()).done) &&
            (c.push(h.value), !b || c.length !== b); d = !0);
          } catch (r) {
            e = !0, f = r
          } finally {
            try {
      ...
      a = b[0];
      var c = b[1], b = b[2];
      return [0 === (Number(b) || 0) ? "" : n[b] + " hundred ", 0 === (Number(a) || 0) ? p[c] : p[c] && p[c] +
      "-" || "", n[c + a] || n[a]].join("")
    }, v = function (a, b) {
      return "" === a ? a : a + " " + t[b]
    };
  ...
  a.getEstimatedTimeLength = function (b, c) {
    var e = a.getWords(b), h = 0, f = a.fallbackMode ? 1300 :
      700;
    c = c || 1;
    e.map(function (a, b) {
